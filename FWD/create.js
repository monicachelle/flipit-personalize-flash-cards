...
//       images: [], // Store images for the card
//       styles: {
//         fontSize: "18px",
//         textColor: "#333333",
//         bgColor: "#fff9f0",
...
//     // Update display without changing content
//     updateCardDisplay();
...
//       try {
//         // Save the current images before any changes
//         const card = cards[currentCardIndex];
//         const currentImages = [...(card.images || [])];
        
//         // Create a span with the selected styles
//         const span = document.createElement('span');
//         span.style.fontSize = fontSize.value;
//         span.style.color = textColor.value;
        
//         // Check for bold/italic/underline using document commands
...
//         // Rebuild display to ensure images are still there
//         updateCardDisplay();
...
//         showMessage("Cannot apply styles to this selection. Try selecting different text.", "error");
//         // Refresh display to fix any issues
//         updateCardDisplay();
//       }
//     } else {
...
//       // Update display to show the new image
//       updateCardDisplay();
...
//   // Save to collection (user-specific)
...
//     // Check if card already exists (compare content, styles, and images)
...
//     // Save only the text content, not the images
//     const card = cards[currentCardIndex];
    
//     // Get all text nodes and save them, but keep images separate
//     const tempDiv = document.createElement('div');
//     tempDiv.innerHTML = cardContent.innerHTML;
...
//   // Set center alignment as active by default
